...
export class VampireSwapFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save VampireSwapFactory entity without an ID");
    assert(
  ...
  static load(id: string): VampireSwapFactory | null {
    return store.get("VampireSwapFactory", id) as VampireSwapFactory | null;
  }
...
export class VampireSwapDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save VampireSwapDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save VampireSwapDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("VampireSwapDayData", id.toString(), this);
  }

  static load(id: string): VampireSwapDayData | null {
    return store.get("VampireSwapDayData", id) as VampireSwapDayData | null;
  }
